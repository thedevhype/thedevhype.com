...
function DitheredWaves({
  ...
  useEffect(() => {
    ...
    // Avoid logging the entire object to prevent circular structure errors
    console.log("Updating resolution:", { newWidth, newHeight });
  ...
  const handlePointerMove = (e) => {
    ...
    // Avoid logging the entire event object
  ...
  useEffect(() => {
    ...
    const handleContextRestored = () => {
      ...
      // Reinitialize any resources if needed
    };
...
export default function Dither({
  ...
  const devicePixelRatio = typeof window !== "undefined" ? window.devicePixelRatio : 1; // Ensure safe access to `window`

  return (
    <Canvas
      className="w-full h-full relative"
      camera={{ position: [0, 0, 6] }}
      dpr={devicePixelRatio} // Use the safely accessed `devicePixelRatio`
